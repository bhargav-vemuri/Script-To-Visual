      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
            <div style={{ width: 40, height: 40, borderRadius: 10, background: 'rgba(245, 255, 198,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Code size={20} color="#F5FFC6" />
            </div>
            <h2 className="font-grotesk" style={{ fontSize: '1.4rem', fontWeight: 700, color: 'var(--text-primary)' }}>API Reference</h2>
          </div>
          
          <div style={{ marginBottom: 24 }}>
            <h3 style={{ fontSize: '1rem', color: '#5B5941', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div style={{ background: '#0a0a0f', padding: '16px', borderRadius: 8, border: '1px solid var(--border)', fontFamily: 'monospace', fontSize: '0.85rem', color: '#F5FFC6' }}>
