    ...
    >
      ...
      <div style={{ position: 'relative', width: 100, height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{
          ...
          inset: -16,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(245, 255, 198,0.2) 0%, transparent 70%)',
          filter: 'blur(8px)',
        }} />
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: '50%',
            padding: 3,
            background: 'conic-gradient(from 0deg, transparent 0%, #F5FFC6 40%, #5B5941 70%, transparent 100%)',
        ...
        <motion.div
          ...
          style={{
            ...
            inset: 6,
            borderRadius: '50%',
            border: '1.5px dashed rgba(245, 255, 198,0.3)',
          }}
        />
        ...
        <motion.div
          ...
          style={{
            ...
            border: '1.5px solid rgba(245, 255, 198,0.5)',
            borderRadius: '50%',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            boxShadow: '0 0 24px rgba(245, 255, 198,0.3)',
            position: 'relative',
            zIndex: 1,
          }}
        >
          <Clapperboard size={32} color="#F5FFC6" />
        </motion.div>
      </div>
        ...
        {streamContent && (
          ...
          >
            ...
            <motion.span
              ...
              style={{ display: 'inline-block', width: 7, height: 13, background: '#F5FFC6', marginLeft: 3, verticalAlign: 'middle' }}
            />
          </div>
        )}
      </div>
